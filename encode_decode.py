...
def decode(ids):
    ...
    # Simply join all bytes and decode as one string
...
def encode():
    ...
    # Calculate bytes before compression
    ...
    # Calculate bytes after compression
    bytes_after = len(final_tokens)
    
    # Calculate and print compression ratio
    compression_ratio = bytes_before / bytes_after
    print(f"---")
    print(f"Bytes before compression: {bytes_before}")
    print(f"Bytes after compression: {bytes_after}")
